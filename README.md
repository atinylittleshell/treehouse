...
- **Interactive shell setup** — `treehouse`/`treehouse get` and `treehouse enter` start a user-selected `bash`, `fish`, or `zsh` as an interactive login shell. Other shells, fallback shells, and Windows use their default invocation.
